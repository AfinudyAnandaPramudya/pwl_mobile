...
class JenisKegiatanPage extends StatefulWidget {
  const JenisKegiatanPage({super.key, required kegiatanId});

  @override
  _JenisKegiatanPageState createState() => _JenisKegiatanPageState();
}

class _JenisKegiatanPageState extends State<JenisKegiatanPage> {
  final Dio _dio = Dio();
          ...
          : kegiatanList.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return KegiatanItem(
                      category: kegiatan['jenis_kegiatan_id'] ??
                          'Tidak ada',
                      title: kegiatan['nama_jenis_kegiatan']?? 'Tidak ada nama',
                      institution: kegiatan['']?[''] ??
                          '',
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => JenisKegiatanPage(
